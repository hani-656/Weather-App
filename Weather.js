...
searchBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    resultBox.innerHTML = `
      ...
      <div class = "w-8 h-8 border-4 font-semibold border-blue-500 border-t-transparent rounded-full animate-spin"></div>
    ...
    resultBox.innerHTML = `
      ...
      <h1 class = " text-5xl font-bold text-blue-500">${data.main.temp}℃🌡️</h1>
      </div> 
